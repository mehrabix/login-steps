    ...
    return (
            ...
            <div className="flex flex-col w-[35%] h-[43vh] rounded-lg overflow-hidden cursor-default ">
                ...
                <div className="bg-white w-full h-[87%] px-12 flex gap-y-4 flex-col items-center justify-center">
                    ...
                    <p className="py-3 border-2 px-3 border-black rounded-lg">{ props.Name }</p>
                    </div>
                    <div className="flex flex-col gap-y-2 w-full">
                    ...
                    <button onClick={props.onClick} className="bg-black mr-auto text-white px-5 py-3 mt-4 rounded-md flex ">ثبت ویرایش</button>
