                ...
                <div className="w-[82%] bg-[#F2F6FB]  h-screen">
                    ...
                    <div className="pt-16 px-10 h-full space-y-5">
                        ...
                        <div className="flex flex-col rounded-b-md overflow-hidden">
                            ...
                            <div className="flex w-full group py-5 pr-28 items-center bg-white">
                                <p className="w-[39%] text-[#2169F5]">گوشی موبایل Iphone 13 Pro Max</p>
                                <p className="w-[20%] ">46000000 تومان </p>
                                <p className="w-[19%] ">اپل </p>
                                <p className="w-[14%] ">21 تیر ۱۴۰۰ </p>
                            ...
                            <div className="flex w-full group py-5 pr-28 items-center bg-[#F9F9F9]">
                                <p className="w-[39%] text-[#2169F5]">گوشی موبایل Iphone 13 Pro Max</p>
                                <p className="w-[20%] ">46000000 تومان </p>
                                <p className="w-[19%] ">اپل </p>
                                <p className="w-[14%] ">21 تیر ۱۴۰۰ </p>
